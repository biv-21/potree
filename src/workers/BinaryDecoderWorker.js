    ...
    if (pointAttribute.name === "POSITION_CARTESIAN") {
      ...
      for (let j = 0; j < numPoints; j++) {
        ...
        if (version.newerThan("1.3")) {
          x =
            view.getUint32(inOffset + j * pointAttributes.byteSize + 0, true) *
            scale;
          y =
            view.getUint32(inOffset + j * pointAttributes.byteSize + 4, true) *
            scale;
          z =
            view.getUint32(inOffset + j * pointAttributes.byteSize + 8, true) *
            scale;
        } else {
          x =
            view.getFloat32(j * pointAttributes.byteSize + 0, true) +
            nodeOffset[0];
          y =
            view.getFloat32(j * pointAttributes.byteSize + 4, true) +
            nodeOffset[1];
          z =
            view.getFloat32(j * pointAttributes.byteSize + 8, true) +
            nodeOffset[2];
        }
      ...
      if (pointAttribute.type.size > 4) {
        ...
        if (pointAttribute.initialRange != null) {
          ...
          scale =
            1 /
            (pointAttribute.initialRange[1] - pointAttribute.initialRange[0]);
        } else {
          offset = min;
          scale = 1 / (max - min);
        }
